...
export default function TransactionsPage() {
    ...
    const exportToExcel = async (data: any[]) => {
        ...
        data.forEach((item, index) => {
            ...
            if (item.date) {
                row.getCell(8).value = new Date(item.date)
                            ...
                            <tbody>
                                {paginatedData.map((row: any, idx: number) => (
                                    ...
                                    >
                                        ...
                                        {/* Stay Type */}
                                        <td className="px-4 py-3.5">
                                            <span className={`text-[11.5px] font-semibold px-2.5 py-1 rounded-md ${row.type?.includes("Short")
                        ...
                        {selected.roomDetails ? (
                                ...
                                {selected.roomDetails.map((r: any, i: number) => (
                                    <div key={i} className="bg-[#f8f7f4] rounded-xl p-3 border border-[#e8e6df]">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span className={`text-[10.5px] font-semibold px-2 py-0.5 rounded-md ${r.status === "occupied"
                                        ...
                                        <div className="flex justify-between text-xs text-[#6b6960]">
                                            ...
                                            <span className={`text-[10.5px] font-semibold px-2 py-0.5 rounded-md ${r.type?.includes("Short")
                                                ? "bg-[#fef8e1] text-[#9a6e00]"
                                                : "bg-[#e8f0ff] text-[#3b5bdb]"
                                                }`}>{r.type}</span>
                                        </div>
                            ...
                            <div className="bg-[#f8f7f4] rounded-xl p-3 border border-[#e8e6df]">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className={`text-[10.5px] font-semibold px-2 py-0.5 rounded-md ${selected.room_status === "occupied"
                                        ? "bg-[#e8f5ee] text-[#1e7a45]"
                                        : "bg-[#f2f0eb] text-[#6b6960]"
                                        }`}>
                                ...
                                <div className="flex justify-between text-xs text-[#6b6960]">
                                    ...
                                    <span className={`text-[10.5px] font-semibold px-2 py-0.5 rounded-md ${selected.type?.includes("Short")
                                        ? "bg-[#fef8e1] text-[#9a6e00]"
                                        : "bg-[#e8f0ff] text-[#3b5bdb]"
                                        }`}>{selected.type}</span>
                                </div>
